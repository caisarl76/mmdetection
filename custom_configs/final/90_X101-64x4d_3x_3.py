_base_ = ['./faster-rcnn_r50_fpn_1x_.py']
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file='final_ann/stats/train_3.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='final_ann/stats/val_3.json',
        data_prefix=dict(img='images/'),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'final_ann/stats/val_3.json',
    metric='bbox',
    backend_args=backend_args)
