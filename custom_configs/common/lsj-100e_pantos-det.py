...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file='annotation_231109/all_train.json',
            data_prefix=dict(img='img_231109/train/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotation_231109/all_val.json',
        data_prefix=dict(img='img_211109/val/'),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotation_231109/all_val.json',
    metric='bbox',
    format_only=False,
    backend_args=backend_args)
