...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file='annotation_231115/train_ver2.json',
            data_prefix=dict(img='img_231115_ver2/train/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='annotation_231115/val_ver2.json',
        data_prefix=dict(img='img_231115_ver2/val/'),
        test_mode=True,
